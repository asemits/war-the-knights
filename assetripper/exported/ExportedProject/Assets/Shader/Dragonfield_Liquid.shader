Shader "Dragonfield/Liquid" {
	Properties {
		[HDR] _Tint ("Tint", Vector) = (1,1,1,1)
		_MainTex ("Texture", 2D) = "white" {}
		_FillAmount ("Fill Amount", Range(-10, 10)) = 0
		[HideInInspector] _ShakeX ("ShakeX", Range(-1, 1)) = 0
		[HideInInspector] _ShakeZ ("ShakeZ", Range(-1, 1)) = 0
		[HDR] _TopColor ("Top Color", Vector) = (1,1,1,1)
		[HDR] _FoamColor ("Foam Line Color", Vector) = (1,1,1,1)
